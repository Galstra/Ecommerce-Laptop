...
--
-- Dumping data untuk tabel `low_spec`
--

INSERT INTO `low_spec` (`id_barang`, `merk_barang`, `stok`, `keterangan`, `harga`, `gambar`, `gambar_2`) VALUES
...
--
-- AUTO_INCREMENT untuk tabel `low_spec`
--
ALTER TABLE `low_spec`
