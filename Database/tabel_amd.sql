...
--
-- Table structure for table `tabel_amd`
--
...
--
-- Dumping data for table `tabel_amd`
--

INSERT INTO `tabel_amd` (`id_barang`, `merk_barang`, `harga`, `keterangan`, `stok`, `gambar`, `gambar_2`) VALUES
...
--
-- AUTO_INCREMENT for table `tabel_amd`
--
ALTER TABLE `tabel_amd`
