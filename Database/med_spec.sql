...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Des 2019 pada 18.46
...
--
-- Dumping data untuk tabel `med_spec`
--

INSERT INTO `med_spec` (`id_barang`, `merk_barang`, `stok`, `keterangan`, `harga`, `gambar`, `gambar_2`) VALUES
...
--
-- AUTO_INCREMENT untuk tabel `med_spec`
--
ALTER TABLE `med_spec`
