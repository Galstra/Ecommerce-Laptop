...
--
-- Table structure for table `tabel_lenovo`
--
...
--
-- Dumping data for table `tabel_lenovo`
--

INSERT INTO `tabel_lenovo` (`id_barang`, `merk_barang`, `stok`, `keterangan`, `harga`, `gambar`, `gambar 2`) VALUES
...
--
-- Indexes for table `tabel_lenovo`
--
...
--
-- AUTO_INCREMENT for table `tabel_lenovo`
--
ALTER TABLE `tabel_lenovo`
