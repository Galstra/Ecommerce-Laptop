                ...
                <div class="panel panel-default sidebar-menu">
                  ...
                  <div class="panel-body">
                    <ul class="nav nav-pills flex-column text-sm category-menu">
                      <li class="nav-item"><a href="<?php echo base_url('home')?>" class="nav-link d-flex align-items-center justify-content-between"><span>Products</span><span class="badge badge-secondary">15</span></a>
                        ...
                        <li class="nav-item"><a href="<?php echo base_url('home')?>" class="nav-link  d-flex align-items-center justify-content-between"><span>Spesification</span><span class="badge badge-light">15</span></a>
                        <ul class="nav nav-pills flex-column">
                      ...
                      <li class="nav-item"><a href="<?php echo base_url('home')?>" class="nav-link d-flex align-items-center justify-content-between"><span>Processor</span><span class="badge badge-secondary">15</span></a>
                        <ul class="nav nav-pills flex-column">
