            ...
            <div class="col">
              ...
              <?php foreach ($barang as $brg) : ?>
                <div class="col-lg-3 col-md-4">
                  <div class="product">
                    <div class="image"><a href="<?php echo base_url()?>wishlist/subDetail/<?= $brg->id_barang ?>"><img src="<?php echo base_url().'/assets/img/'.$brg->gambar?>"class="img-fluid image1"></a></div>
                    <div class="text">
                      <h3 class="h5"><?php echo $brg->merk_barang ?></a></h3>
                      <p class="price"><?php $harga=number_format($brg->harga); echo $harga ?></p><a href="<?php echo base_url () ?>wishlist/hapuscart/<?php echo  $brg->id_barang ?>" ><i class="fa fa-trash-o fa-3x"></i></a>
                    </div>
                  </div>
                </div>
                <?php endforeach;?>
