            ...
            <div class="col-md-9">
              ...
              <?php foreach ($barang as $brg) : ?>
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="image"><a href="<?php echo base_url()?>kategori/lowspec/subDetail/<?= $brg->id_barang ?>"><img src="<?php echo base_url().'/assets/img/'.$brg->gambar?>"class="img-fluid image1"></a></div>
                    <div class="text">
